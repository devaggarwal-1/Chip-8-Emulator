class CPU {
    ...
    executeInstruction(opcode) {
        ...
        //Let's assume we have an instruction 0x5460. If we & (bitwise AND) that instruction with 
        //hex value 0x0F00 we'll end up with 0x0400. Shift that 8 bits right and we end up with 0x04 or 0x4.
